    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        @media screen and (max-width: 320px) {
          ...
          ::slotted(*) {
            font-size: 14px; /* ukuran font yang lebih kecil untuk tampilan di iPhone SE */
            overflow-x: hidden; /* menghilangkan scroll horizontal */
            text-overflow: ellipsis; /* mengganti konten yang terpotong dengan titik-titik */
            white-space: nowrap; /* menghindari pemotongan kata pada konten */
            max-width: 100%; /* Memastikan elemen tidak melebihi lebar layar */
          }
        }
        ...
        @media (prefers-color-scheme: dark) {
          ...
          ::slotted(*) {
            ...
            color: #f4f4f4;
            margin: 0 auto;
            justify-content: flex-start; /* untuk tampilan desktop */
            align-items: flex-start; /* untuk tampilan desktop */
            width: 100%;
          }
        }
      </style>
...
class UkmpBerita extends PolymerElement {
  static get template() {
    return html`
      <style>
      :host{
      ...
      .carousel {
        position: relative;
        height: 80vh; /* Menyesuaikan tinggi carousel dengan viewport */
        overflow: hidden;
      }
      ...
      .slide img {
        height: 100%;
        width: 100%; /* Menyesuaikan lebar gambar dengan viewport */
        object-fit: cover;
      }
      
      .slide kartu-story-slide {
        position: absolute;
        right: 0;
        top: 50%;
      ...
      .card-grid {
        ...
        --card-grid-columns: repeat(auto-fill, minmax(280px, 1fr));
        --card-grid-rows: repeat(1, 1fr);
        --card-grid-gap: 20px; /* Menambahkan jarak antar card */
      ...
      .ukmp-slide-content h2 {
        margin-top: 0;
        font-size: 2em;
      }
      
      .ukmp-slide-content p {
        margin-bottom: 0;
        font-size: 1.2em;
      }
      
      .ukmp-slide-content a {
        display: block;
        margin-top: 20px;
        padding: 10px;
      ...
      <div class="carousel">
        <div class="slides">
          <div class="slide" style>
            <img src="../logo/background.jpeg" alt="Slide 1">
            <kartu-story-slide></kartu-story-slide>
          </div>
          <div class="slide">
            <img src="https://via.placeholder.com/300x200?text=Slide+2" alt="Slide 2">
          </div>
          <div class="slide">
            <img src="https://via.placeholder.com/300x200?text=Slide+3" alt="Slide 3">
          </div>
        </div>
      </div>
      <div class="card-grid">
        <ukmp-slide-content title="Bakti Sosial" description="Bakti Sosial" url="../ig" background-Image="../logo/IMG20230415185452.jpg" image-alt="Gambar Nutriwarrior" show-img></ukmp-slide-content>
        <ukmp-slide-content title="Twitter" description="Twitter" url="../tw" background-Image="../logo/background.jpeg"></ukmp-slide-content>
        <ukmp-slide-content title="Facebook" description="Facebook" url="../fb" background-Image="../logo/background.jpeg"></ukmp-slide-content>
      </div>
    `;
  }
  ...
  startCarousel() {
    ...
    const nextSlide = () => {
      ...
      this.slides.style.transform = `translateX(-${this.currentSlideIndex * 100}%)`;
    };
...
customElements.define("ukmp-berita", UkmpBerita);

class kartuStorSi extends PolymerElement {
  static get template() {
    return html`
    <style>
        :host {
      ...
      <div class="card-grid">
        <div class="right-column">
          <ukmp-kartu-story tag="ukmp-kartu-story" title="Bakti Sosial" color-H="black" color-A="black" color-P="black" description="Data Alumni" url="../story/baksos/" background-Image="../logo/IMG20230415185452.jpg"></ukmp-kartu-story>
          <ukmp-kartu-story tag="ukmp-kartu-story" title="Bakti Sosial" description="FMI x UKMP" url="../story/baksos/" background-Image="../logo/IMG20230415171811.jpg"></ukmp-kartu-story>
        </div>
      </div>  
    `;
  }
...
customElements.define("kartu-story-slide", kartuStorSi);

class UKMPKartuSosCon extends PolymerElement {
  constructor() {
    super();
...
customElements.define("ukmp-slide-content", UKMPKartuSosCon);
...
class kartuDep extends PolymerElement {
  static get template() {
    return html`
      ...
      .card-grid {
        --card-grid-display: grid;
        --card-grid-columns: repeat(auto-fit, minmax(280px, 1fr));
      ...
      .card-grid ukmp-kartu {
        width: 100%;
      }
      
      @media screen and (max-width: 767px) {
        .card-grid {
          --card-grid-columns: repeat(auto-fit, minmax(100%, 1fr));
          --card-grid-rows: auto;
          --card-grid-gap: 10px;
        }
      }
      ...
      @media screen and (min-width: 768px) and (max-width: 1023px) {
        .card-grid {
          --card-grid-columns: repeat(2, minmax(280px, 1fr));
          --card-grid-rows: auto;
          --card-grid-gap: 20px;
        }
      }
      ...
      @media screen and (min-width: 1024px) {
        .card-grid {
          --card-grid-columns: repeat(3, minmax(280px, 1fr));
          --card-grid-rows: auto;
          --card-grid-gap: 20px;
        }
      }                  
    ...
    <div class="card-grid">
      <ukmp-kartu title="PH" description="PH" url="./ph" skeleton image-src="../logo/PH.jpg" image-alt="PH logo" show-img></ukmp-kartu>
      <ukmp-kartu title="HRD" description="HRD" url="./hrd" skeleton image-src="../logo/HRD.jpg" image-alt="HRD logo" show-img></ukmp-kartu>
      <ukmp-kartu title="DD" description="DD" url="./dd" skeleton image-src="../logo/DD.jpg" image-alt="DD logo" show-img></ukmp-kartu>
      <ukmp-kartu title="COMDEV" description="COMDEV" url="./cdv" skeleton image-src="../logo/COMDEV.png" image-alt="COMDEV logo" show-img></ukmp-kartu>
      <ukmp-kartu title="STD" description="STD" url="./std" skeleton image-src="../logo/STD.png" image-alt="PRD logo" show-img></ukmp-kartu>
      <ukmp-kartu title="PRD" description="PRD" url="./prd" skeleton image-src="../logo/PRD.jpg" image-alt="PRD logo" show-img></ukmp-kartu>
      <ukmp-kartu title="RED" description="PRD" url="./prd" skeleton image-src="../logo/RED.jpg" image-alt="RED logo" show-img></ukmp-kartu>
      <ukmp-kartu title="KARYA" description="PRD" url="./prd" skeleton image-src="../logo/arunika.webp" image-alt="PRD logo" show-img></ukmp-kartu>
    </div>
  `
  }
}
...
class kartuMed extends PolymerElement {
  static get template() {
    return html`
      ...
      .card-grid {
        --card-grid-display: grid;
        --card-grid-columns: repeat(auto-fill, minmax(500px, 1fr));
        --card-grid-rows: repeat(1, 1fr);
        --card-grid-gap: 20px;
        display: var(--card-grid-display);
        grid-template-columns: var(--card-grid-columns);
      ...
      @media only screen and (max-width: 768px) {
        .card-grid {
          --card-grid-display: grid;
          --card-grid-columns: repeat(auto-fill, minmax(380px, 1fr));
          --card-grid-rows: repeat(1, 1fr);
          --card-grid-gap: 20px;
          display: var(--card-grid-display);
          grid-template-columns: var(--card-grid-columns);
    ...
    <style>
        ...
        @media only screen and (max-width: 320px) {
          ...
          .right-column {
            ...
            justify-items: stretch;
            width: max-content;
            margin: 0 auto; /* Tambahkan kode ini untuk memusatkan div */
          }
          .right-column ukmp-kartu-story:nth-child(n+5) {
            display: none;
          }
