...
class HomeApp extends PolymerElement {
    static get template() {
        return html`
            ...
            <div class="logo-window">
                <image-component class="logo-ukmp" src="/../../images/ukmp-logo-144x144.png"/></image-component>
                <image-component class="logo-arunika" src="/../../images/arunika.png"/></image-component>
            </div>
                            ...
                            <div class="grid">
                                <ukmp-grid class="list-grid">
                                    <div class="img-op" data-link="https://ukmpapps.web.app/download" on-click="navigateToLink" >
                                        <button class="centered-button" data-link="https://ukmpapps.web.app/download" on-click="navigateToLink" >
            ...
            <div class$="{{storyPKMStartApp}} image-component" id="image1">
                <div id="notif">
                ...
                <button class="button story-button-prev-start-pkm" on-click="nextStory">
                ...
                <image-component src="/../images/prestasi/jabar.pkm.png" alt="Gambar 1"></image-component>
            </div>
            <div class$="{{storyPKMSecoundApp}} image-component" id="image2">
                <div id="notif">
                    <button class="centered-button"on-click="openNotif">
                        <image-component class="notification" alt="Notification" src="/../../images/notification.png" /></image-component>
                    </button>
                ...
                <button class="button story-button-prev-secound-pkm" on-click="prevStory">
    ...
    nextStory() {
        this.storyPKMStartApp = "hidden"; // Menambahkan kelas "hidden" pada travelAppSplashClass
        this.storyPKMSecoundApp = "";
    }

    prevStory() {
        this.storyPKMSecoundApp = "hidden";
        this.storyPKMStartApp = ""; // Menambahkan kelas "hidden" pada travelAppSplashClass
    }
    ...
    connectedCallback() {
        ...
        const buttonPKMClicked = localStorage.getItem('buttonPKMClicked')
